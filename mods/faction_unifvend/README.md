...
- `code/__defines/~mods/faction_univend[d[d[d[dfvend.dm`: `FACTION_UNIVEND[D[D[D[DFVEND_SPEED_MULTIPLIER`, `FACTION_UNIVEND[D[D[D[DFVEND_SPEED_BASE`
<!--
